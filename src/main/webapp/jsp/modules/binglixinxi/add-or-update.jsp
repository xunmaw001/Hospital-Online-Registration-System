...
<body>
	<div id="main-container">
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>诊断内容</label>
					<textarea  name="zhenduanneirong" class="form-control textarea" id="zhenduanneirong" rows="3"></textarea>
				</div>
				<div class="form-item">
					<label>诊断结果</label>
					<textarea  name="zhenduanjieguo" class="form-control textarea" id="zhenduanjieguo" rows="3"></textarea>
				</div>
				<div class="form-item">
					<label>病历描述</label>
					<textarea  name="binglimiaoshu" class="form-control textarea" id="binglimiaoshu" rows="3"></textarea>
				</div>
				<div class="form-item">
					<label>注意事项</label>
					<textarea  name="zhuyishixiang" class="form-control textarea" id="zhuyishixiang" rows="3"></textarea>
				</div>
				<div class="form-item">
					<label>就诊时间</label>
					<input id="jiuzhenshijian-input" class="date" name="jiuzhenshijian" size="20" type="text" readonly placeholder="请选择就诊时间">
				</div>
				<div class="form-item">
					<label>医生账号</label>
	...
	<script>
		...
		function dateTimePick(){
			...
			$("#jiuzhenshijian-input").val(getCurDateTime());
			$("#jiuzhenshijian-input").datetimepicker({ 
				autoclose: true,
			...
			function fill(){
				...
				http(accountTableName+'/session','GET',{},(res)=>{
					if(res.code == 0){
						...
						if(res.data !=null && res.data.yishengzhanghao != null && res.data.yishengzhanghao != ''){
		...
		function dataBind(){
			...
			$("#zhenduanneirong").val(ruleForm.zhenduanneirong);
			$("#zhenduanjieguo").val(ruleForm.zhenduanjieguo);
			$("#binglimiaoshu").val(ruleForm.binglimiaoshu);
			$("#zhuyishixiang").val(ruleForm.zhuyishixiang);
			$("#jiuzhenshijian-input").val(ruleForm.jiuzhenshijian);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.zhenduanneirong != null && res.data.zhenduanneirong != ''){

						$("#zhenduanneirong").val(res.data.zhenduanneirong);
					}
					if(res.data != null && res.data != '' && res.data.zhenduanjieguo != null && res.data.zhenduanjieguo != ''){

						$("#zhenduanjieguo").val(res.data.zhenduanjieguo);
					}
					if(res.data != null && res.data != '' && res.data.binglimiaoshu != null && res.data.binglimiaoshu != ''){

						$("#binglimiaoshu").val(res.data.binglimiaoshu);
					}
					if(res.data != null && res.data != '' && res.data.zhuyishixiang != null && res.data.zhuyishixiang != ''){

						$("#zhuyishixiang").val(res.data.zhuyishixiang);
					}
					if(res.data != null && res.data != '' && res.data.jiuzhenshijian != null && res.data.jiuzhenshijian != ''){

						$("#jiuzhenshijian-input").val(res.data.jiuzhenshijian);
						$('#jiuzhenshijianFileName').val(res.data.jiuzhenshijian)
					}
