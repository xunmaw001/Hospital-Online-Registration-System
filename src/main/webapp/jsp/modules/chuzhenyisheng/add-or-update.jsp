...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑出诊医生</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>编辑出诊医生</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>出诊日期</label>
					<input id="chuzhenriqi-input" class="date" name="chuzhenriqi" size="15" type="text" readonly placeholder="请选择出诊日期">
				</div>
				<div class="form-item">
					<label>医院账号</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "chuzhenyisheng/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("chuzhenyisheng/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("chuzhenyisheng/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("chuzhenyisheng/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#chuzhenriqi-input").datetimepicker({ 
				minView: "month",
				autoclose: true,
				format:'yyyy-mm-dd',
				language:'zh-CN',
		...
		function dataBind(){
			...
			$("#chuzhenriqi-input").val(ruleForm.chuzhenriqi);
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.chuzhenriqi != null && res.data.chuzhenriqi != ''){
						...
						$("#chuzhenriqi-input").val(res.data.chuzhenriqi);
						$('#chuzhenriqiFileName').val(res.data.chuzhenriqi)
					}
