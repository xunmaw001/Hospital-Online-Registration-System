...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">出诊医生管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>出诊医生管理</span></li>
				<li class="breadcrumb-item-two"><span>出诊医生列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
		...
		<div id="center-container">
			...
			<div class="center-form">
				...
				<div class="form-item">
					<label>医院名称</label>
					<input type="text" id="yiyuanmingchengSearch" class="form-control form-control-sm" placeholder="请输入医院名称" aria-controls="tableId">
				</div>
	...
	<script>
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("chuzhenyisheng/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function discussList(id) {
            ...
            window.location.href = "../discusschuzhenyisheng/list.jsp"
        }
		//清除会重复渲染的节点
        function clear(){
	...
	function getSum(colName){
		http("chuzhenyisheng"+colName,"GET",{
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"chuzhenyisheng");
