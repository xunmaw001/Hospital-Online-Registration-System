	...
	<div id="main-container">
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>取消原因</label>
					<input name="quxiaoyuanyin" id="quxiaoyuanyin" name="quxiaoyuanyin" class="form-control" placeholder="请输入取消原因">
				</div>
				<div class="form-item">
					<label>取消时间</label>
					<input id="quxiaoshijian-input" class="date" name="quxiaoshijian" size="20" type="text" readonly placeholder="请选择取消时间">
				</div>
				<div class="form-item">
					<label>患者账号</label>
	...
	<script>
				...
				if(crossrefid && crossuserid) {
					...
					http("yuyuequxiao/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("yuyuequxiao/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("yuyuequxiao/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#quxiaoshijian-input").datetimepicker({ 
				autoclose: true,
