...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">预约挂号管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>预约挂号列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
			...
			<table id="tableId" class="table table-bordered">
				<thead>
					<tr>
						...
						<th onclick="sort('chuzhenriqi')">出诊日期<i id="chuzhenriqiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var chuzhenriqiCell  = document.createElement('td');

						 chuzhenriqiCell.innerHTML = item.chuzhenriqi;

			row.appendChild(chuzhenriqiCell);
			...
			var crossBtn0 = document.createElement('button');
            		crossBtn0.innerHTML = "预约取消"
			crossBtn0.setAttribute("type","button");
			crossBtn0.setAttribute("class","btn btn-primary btn-sm");
			crossBtn0.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'yuyuequxiao','是','[1]','请勿重复操作')");
			if(crossBtnControl('预约取消') == true){
				btnGroup.appendChild(crossBtn0);
			}   
			var crossBtn1 = document.createElement('button');
            		crossBtn1.innerHTML = "病历信息"
			crossBtn1.setAttribute("type","button");
			crossBtn1.setAttribute("class","btn btn-primary btn-sm");
			crossBtn1.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'binglixinxi','是','','')");
			if(crossBtnControl('病历信息') == true){
