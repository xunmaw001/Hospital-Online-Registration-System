...
<body>
	...
	<div class="content">
			<form id="registerForm" action="" method="post">
				...
				<div class="list-item">
					<input  name="huanzhezhanghao"  placeholder="请输入患者账号" class="form-control-i">
				</div>
				<div class="list-item">
				...
				<div class="list-item">
					<input  name="huanzhexingming"  placeholder="请输入患者姓名" class="form-control-i">
				</div>
				...
				<div class="list-item">
					<input  name="huanzhezhuzhi"  placeholder="请输入患者住址" class="form-control-i">
				</div>
