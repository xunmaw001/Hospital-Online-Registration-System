...
<body>
	<div id="main-container">
		...
		<div id="center-container">
			...
			<div class="center-form">
				<div class="form-item">
					<label>患者账号</label>
					<input type="text" id="huanzhezhanghaoSearch" class="form-control form-control-sm" placeholder="请输入患者账号" aria-controls="tableId">
				</div>
				<div class="form-item">
					<label>患者姓名</label>
			...
			<table id="tableId" class="table table-bordered">
				<thead>
					<tr>
						...
						<th onclick="sort('huanzhezhuzhi')">患者住址<i id="huanzhezhuzhiIcon" class="fa fa-sort"></i></th>
						<th>操作</th>
					</tr>
				</thead>
				<tbody></tbody>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#huanzhezhanghaoSearch').val() != null && $('#huanzhezhanghaoSearch').val() != ''){
				searchForm.huanzhezhanghao ="%" +  $('#huanzhezhanghaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("huanzhe/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
				huanzhezhanghao : searchForm.huanzhezhanghao,	
		...
		function setDataRow(item,number){
			...
			var huanzhezhuzhiCell  = document.createElement('td');

						 huanzhezhuzhiCell.innerHTML = item.huanzhezhuzhi;

			row.appendChild(huanzhezhuzhiCell);
