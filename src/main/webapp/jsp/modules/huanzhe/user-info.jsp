...
<body>
	<div id="main-container">
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>患者账号</label>
					<input name="huanzhezhanghao" readonly id="huanzhezhanghao" name="huanzhezhanghao" class="form-control" placeholder="请输入患者账号">
				</div>
				<div class="form-item">
					<label>患者姓名</label>
				...
				<div class="form-item">
					<label>患者住址</label>
					<input name="huanzhezhuzhi"  id="huanzhezhuzhi" name="huanzhezhuzhi" class="form-control" placeholder="请输入患者住址">
				</div>
	...
	<script>
		...
		function dataBind(){
			...
			$("#huanzhezhuzhi").val(ruleForm.huanzhezhuzhi);	
		}		
		//图片显示
		function showImg(){
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.huanzhezhuzhi != null && res.data.huanzhezhuzhi != ''){

					$("#huanzhezhuzhi").val(res.data.huanzhezhuzhi);
					}
				}
			});  
            }
