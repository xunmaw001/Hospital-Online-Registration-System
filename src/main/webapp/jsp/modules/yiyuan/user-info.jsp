...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑医院</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>编辑医院</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>医院账号</label>
					<input name="yiyuanzhanghao" readonly id="yiyuanzhanghao" name="yiyuanzhanghao" class="form-control" placeholder="请输入医院账号">
				</div>
				<div class="form-item">
					<label>医院名称</label>
	...
	<script>
		...
		function submit() {
			...
			if(validform() ==true && compare() == true){
				...
				httpJson("yiyuan/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
