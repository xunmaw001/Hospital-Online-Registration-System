...
<body>
	...
	<div class="content">
			<form id="registerForm" action="" method="post">
				...
				<div class="list-item">
					<input  name="yiyuanzhanghao"  placeholder="请输入医院账号" class="form-control-i">
				</div>
				<div class="list-item">
				...
				<div class="list-item">
					<input  name="yiyuanmingcheng"  placeholder="请输入医院名称" class="form-control-i">
				</div>
                <div class="list-item-img">
                    <img id="fengmianImg" src="" width="100" height="100">
                    <div class="upload btn-img">请选择封面<input name="file" type="file" id="fengmianupload" class="form-control-file"></div>
                    <input name="fengmian" id="fengmian-input" type="hidden">
                </div>
				<div class="list-item">
					<input  name="fuzeren"  placeholder="请输入负责人" class="form-control-i">
				</div>
				<div class="list-item">
					<input  name="lianxidianhua"  placeholder="请输入联系电话" class="form-control-i">
				</div>
				<div class="list-item">
					<input  name="yiyuandizhi"  placeholder="请输入医院地址" class="form-control-i">
				</div>
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				var url = baseUrl + "yiyuan/register";
				$.ajax({ 
					type: "POST",
					url: url,
