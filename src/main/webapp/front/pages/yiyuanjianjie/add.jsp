			...
			<div class="data-add-container" :style='{"padding":"30px 7% 40px","margin":"10px auto","alignItems":"flex-start","flexWrap":"wrap","background":"rgba(255,255,255,0)","display":"block","width":"100%","justifyContent":"space-between"}'>
				<form class="layui-form layui-form-pane add" lay-filter="myForm">
					...
					<div :style='{"padding":"10px","margin":"0 0 10px 0","borderColor":"#c6ecc6","alignItems":"center","borderWidth":"0px","background":"linear-gradient(180deg, rgba(255,255,255,1) 0%, rgba(178,213,232,1) 100%)","display":"flex","borderStyle":"solid"}' class="layui-form-item">
						<div :style='{"width":"150px","padding":"0 15px","lineHeight":"44px","fontSize":"16px","color":"#278bc0","textAlign":"right"}' class="label">医院图片：</div>
						<img :style='{"minHeight":"80px","width":"120px","margin":"0 10px 0 0","objectFit":"cover","height":"auto"}' v-if="detail.yiyuantupian" id="yiyuantupianImg" :src="baseurl+detail.yiyuantupian">
						<input v-if="detail.yiyuantupian" type="hidden" :value="detail.yiyuantupian" id="yiyuantupian" name="yiyuantupian" />
						<button v-if="!ro.yiyuantupian" :style='{"cursor":"pointer","border":"0","padding":"0px 20px","boxShadow":"inset 0px 0px 0px 0px #278bc0","margin":"0","borderColor":"#278bc0","color":"#278bc0","minWidth":"110px","outline":"none","borderRadius":"30px","background":"#fff","borderWidth":"1px","width":"auto","fontSize":"14px","lineHeight":"36px","borderStyle":"solid","height":"40px"}' type="button" class="layui-btn btn-theme" id="yiyuantupianUpload">
							<i :style='{"margin":"0 10px 0 0","fontSize":"14px","color":"#278bc0","display":"inline-block"}' class="layui-icon">&#xe67c;</i>上传医院图片
						</button>
					</div>
					<div :style='{"padding":"10px","margin":"0 0 10px 0","borderColor":"#c6ecc6","alignItems":"center","borderWidth":"0px","background":"linear-gradient(180deg, rgba(255,255,255,1) 0%, rgba(178,213,232,1) 100%)","display":"flex","width":"100%","borderStyle":"solid","float":"left"}' class="layui-form-item">
					...
					<div :style='{"padding":"10px","margin":"0 0 10px 0","borderColor":"#c6ecc6","alignItems":"center","borderWidth":"0px","background":"linear-gradient(180deg, rgba(255,255,255,1) 0%, rgba(178,213,232,1) 100%)","display":"flex","width":"100%","borderStyle":"solid","float":"left"}' class="layui-form-item">
						<div :style='{"width":"150px","padding":"0 15px","lineHeight":"40px","fontSize":"16px","color":"#278bc0","textAlign":"right"}' class="label">医院地址：</div>
						<input :style='{"padding":"0 10px","margin":"0","borderColor":"#ddd","color":"#666","outline":"none","borderRadius":"30px","borderWidth":"1px","background":"#fff","width":"350px","fontSize":"14px","lineHeight":"40px","borderStyle":"solid","height":"40px"}' v-model="detail.yiyuandizhi" type="text" :readonly="ro.yiyuandizhi" name="yiyuandizhi" id="yiyuandizhi" autocomplete="off" class="layui-input">
					</div>
					<div :style='{"padding":"10px","margin":"0 0 10px 0","borderColor":"#c6ecc6","alignItems":"center","borderWidth":"0px","background":"linear-gradient(180deg, rgba(255,255,255,1) 0%, rgba(178,213,232,1) 100%)","display":"flex","width":"100%","borderStyle":"solid","float":"left"}' class="layui-form-item">
					...
					<div :style='{"margin":"0 0 10px 0","alignItems":"center","background":"linear-gradient(180deg, rgba(255,255,255,1) 0%, rgba(178,213,232,1) 100%)","display":"flex"}' class="layui-form-item">
						<div :style='{"width":"150px","padding":"0 15px","lineHeight":"44px","fontSize":"16px","color":"#278bc0","textAlign":"right"}' class="label">医院简介：</div>
						<textarea :style='{"padding":"0","boxShadow":"0 0 0px rgba(75,223,201,.5)","margin":"20px 0 20px","borderColor":"#ddd","backgroundColor":"rgba(255,255,255,.8)","borderRadius":"0","borderWidth":"1px","width":"88%","borderStyle":"solid","height":"auto"}' name="yiyuanjianjie" id="yiyuanjianjie">请输入医院简介</textarea>
					</div>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
				...
				var yiyuantupianUpload = upload.render({
					...
					// 上传成功
						...
						if (res.code == 0) {
							...
							jquery('#yiyuantupianImg').attr('src', http.baseurl +url)
				...
				http.request(`${table}/session`, 'get', {}, function(data) {
					...
					data = data.data
					for(var key in data){
                        if(key=='yiyuanmingcheng'){
                                vue.detail['yiyuanmingcheng'] = data[`${key}`]
                                vue.ro.yiyuanmingcheng = true;
                                continue;
                        }
                        if(key=='yiyuanzhanghao'){
                                vue.detail['yiyuanzhanghao'] = data[`${key}`]
                ...
                if(http.getParam('corss')){
					...
					for(var o in obj){
                                        ...
                                        if(o=='yiyuandizhi'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.yiyuandizhi = true;
                                                continue;
                                        }
                                        if(o=='lingdaojianjie'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.lingdaojianjie = true;
                                                continue;
                                        }
                                        if(o=='yiyuanjianjie'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.yiyuanjianjie = true;
                                                continue;
                                        }
                                        if(o=='yiyuanzhanghao'){
                                                vue.detail[o] = obj[o];
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
					var yiyuanjianjie = tinymce.get('#yiyuanjianjie').getContent()
					data.yiyuanjianjie = yiyuanjianjie;
