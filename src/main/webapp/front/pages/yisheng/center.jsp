	...
	<body>
		<div id="app">
			...
			<div id="center-container">
				...
				<!-- 个人中心菜单 -->
				<!-- 个人中心 -->
				<div :style='{"padding":"0px","margin":"40px 0 0 7%","borderColor":"#2286bc","background":"rgba(255,255,255,.9)","borderWidth":"0px","width":"calc(86% - 350px)","borderStyle":"solid"}' class="right-container">
					<form :style='{"padding":"60px 0px 30px","boxShadow":"0px 0px 0px #eee","borderColor":"#eee","borderRadius":"0","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20230127/26adbfa03b974a4b8b465c121356adec.png) no-repeat left top,#fff","borderWidth":"0px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"space-between","height":"auto"}' class="layui-form" lay-filter="myForm">
						<!-- 主键 -->
						...
						<div class="layui-form-item"  :style='{"padding":"10px","margin":"0 0 10px 0","borderColor":"#c6ecc6","alignItems":"center","background":"none","borderWidth":"0px","display":"flex","width":"100%","borderStyle":"solid"}'>
							<label :style='{"width":"150px","padding":"0 15px","lineHeight":"40px","fontSize":"16px","color":"#2286bc","textAlign":"right"}' class="layui-form-label">医生账号</label>
							<input :style='{"padding":"0 10px","margin":"0","borderColor":"#ddd","color":"#333","outline":"none","borderRadius":"30px","borderWidth":"1px","background":"none","width":"360px","fontSize":"14px","lineHeight":"40px","borderStyle":"solid","height":"40px"}' type="text" readonly="readonly" name="yishengzhanghao" name="yishengzhanghao" id="yishengzhanghao" placeholder="医生账号" autocomplete="off" class="layui-input">
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","margin":"0 0 10px 0","borderColor":"#c6ecc6","alignItems":"center","background":"none","borderWidth":"0px","display":"flex","width":"100%","borderStyle":"solid"}'>
						...
						<div class="layui-form-item"  :style='{"padding":"10px","margin":"0 0 10px 0","borderColor":"#c6ecc6","alignItems":"center","background":"none","borderWidth":"0px","display":"flex","width":"100%","borderStyle":"solid"}'>
							<label :style='{"width":"150px","padding":"0 15px","lineHeight":"40px","fontSize":"16px","color":"#2286bc","textAlign":"right"}' class="layui-form-label">医生姓名</label>
							<input :style='{"padding":"0 10px","margin":"0","borderColor":"#ddd","color":"#333","outline":"none","borderRadius":"30px","borderWidth":"1px","background":"none","width":"360px","fontSize":"14px","lineHeight":"40px","borderStyle":"solid","height":"40px"}' type="text"  name="yishengxingming" name="yishengxingming" id="yishengxingming" placeholder="医生姓名" autocomplete="off" class="layui-input">
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","margin":"0 0 10px 0","borderColor":"#c6ecc6","alignItems":"center","background":"none","borderWidth":"0px","display":"flex","width":"100%","borderStyle":"solid"}'>
						...
						<div class="layui-form-item"  :style='{"padding":"10px","margin":"0 0 10px 0","borderColor":"#c6ecc6","alignItems":"center","background":"none","borderWidth":"0px","display":"flex","width":"100%","borderStyle":"solid"}'>
							<label :style='{"width":"150px","padding":"0 15px","lineHeight":"40px","fontSize":"16px","color":"#2286bc","textAlign":"right"}' class="layui-form-label">手机号码</label>
							<input :style='{"padding":"0 10px","margin":"0","borderColor":"#ddd","color":"#333","outline":"none","borderRadius":"30px","borderWidth":"1px","background":"none","width":"360px","fontSize":"14px","lineHeight":"40px","borderStyle":"solid","height":"40px"}' type="text"  name="shoujihaoma" name="shoujihaoma" id="shoujihaoma" placeholder="手机号码" autocomplete="off" class="layui-input">
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","margin":"0 0 10px 0","borderColor":"#c6ecc6","alignItems":"center","background":"none","borderWidth":"0px","display":"flex","width":"100%","borderStyle":"solid"}'>
							<label :style='{"width":"150px","padding":"0 15px","lineHeight":"40px","fontSize":"16px","color":"#2286bc","textAlign":"right"}' class="layui-form-label">科室</label>
						...
						<div class="layui-form-item"  :style='{"padding":"10px","margin":"0 0 10px 0","borderColor":"#c6ecc6","alignItems":"center","background":"none","borderWidth":"0px","display":"flex","width":"100%","borderStyle":"solid"}'>
							<label :style='{"width":"150px","padding":"0 15px","lineHeight":"40px","fontSize":"16px","color":"#2286bc","textAlign":"right"}' class="layui-form-label">职称</label>
							<input :style='{"padding":"0 10px","margin":"0","borderColor":"#ddd","color":"#333","outline":"none","borderRadius":"30px","borderWidth":"1px","background":"none","width":"360px","fontSize":"14px","lineHeight":"40px","borderStyle":"solid","height":"40px"}' type="text"  name="zhicheng" name="zhicheng" id="zhicheng" placeholder="职称" autocomplete="off" class="layui-input">
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","margin":"0 0 10px 0","borderColor":"#c6ecc6","alignItems":"center","background":"none","borderWidth":"0px","display":"flex","width":"100%","borderStyle":"solid"}'>
							<label :style='{"width":"150px","padding":"0 15px","lineHeight":"40px","fontSize":"16px","color":"#2286bc","textAlign":"right"}' class="layui-form-label">医院账号</label>
							<input :style='{"padding":"0 10px","margin":"0","borderColor":"#ddd","color":"#333","outline":"none","borderRadius":"30px","borderWidth":"1px","background":"none","width":"360px","fontSize":"14px","lineHeight":"40px","borderStyle":"solid","height":"40px"}' type="text"  name="yiyuanzhanghao" name="yiyuanzhanghao" id="yiyuanzhanghao" placeholder="医院账号" autocomplete="off" class="layui-input">
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","margin":"0 0 10px 0","borderColor":"#c6ecc6","alignItems":"center","background":"none","borderWidth":"0px","display":"flex","width":"100%","borderStyle":"solid"}'>
							<label :style='{"width":"150px","padding":"0 15px","lineHeight":"40px","fontSize":"16px","color":"#2286bc","textAlign":"right"}' class="layui-form-label">医院名称</label>
							<input :style='{"padding":"0 10px","margin":"0","borderColor":"#ddd","color":"#333","outline":"none","borderRadius":"30px","borderWidth":"1px","background":"none","width":"360px","fontSize":"14px","lineHeight":"40px","borderStyle":"solid","height":"40px"}' type="text"  name="yiyuanmingcheng" name="yiyuanmingcheng" id="yiyuanmingcheng" placeholder="医院名称" autocomplete="off" class="layui-input">
						</div>
